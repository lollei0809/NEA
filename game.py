...
class GamePlay():
    ...
    def get_question_type(self):
        self.types = ["btd", "dtb", "smtd", "dtsm", "htd", "dth"]
        self.type_num = pyip.inputMenu(["unsigned binary to decimal",
                                             "decimal to unsigned binary",
                                             "sign and magnitude binary to decimal",
                                             "decimal to sign and magnitude binary"
                                             "hexadecimal to decimal",
                                             "decimal to hexadecimal"],
                                            prompt="enter question type (1-6):\n",
                                            numbered=True)
        self.question.question_type = self.types[int(self.type_num)-1]
